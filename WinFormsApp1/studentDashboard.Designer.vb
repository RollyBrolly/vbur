...
Partial Class studentDashboard
    ...
    Private Sub InitializeComponent()
        ...
        ' PictureBox1
        ' 
        PictureBox1.Image = My.Resources.Resources.studentdashboardHeader2
        PictureBox1.Location = New Point(-2, 1)
        PictureBox1.Margin = New Padding(3, 2, 3, 2)
        PictureBox1.Name = "PictureBox1"
        PictureBox1.Size = New Size(1670, 107)
        ...
        Panel1.Location = New Point(490, 466)
        Panel1.Margin = New Padding(3, 2, 3, 2)
        Panel1.Name = "Panel1"
        Panel1.Size = New Size(351, 266)
        Panel1.TabIndex = 66
        ' 
        ' PictureBox2
        ' 
        ...
        CheckBox3.Font = New Font("Segoe UI", 13.8F, FontStyle.Bold)
        CheckBox3.ForeColor = Color.Indigo
        CheckBox3.Location = New Point(21, 161)
        CheckBox3.Margin = New Padding(3, 2, 3, 2)
        CheckBox3.Name = "CheckBox3"
        CheckBox3.Size = New Size(291, 29)
        CheckBox3.TabIndex = 71
        CheckBox3.Text = "Give supervisor cup of coffee"
        CheckBox3.UseVisualStyleBackColor = True
        ' 
        ' CheckBox2
        ' 
        CheckBox2.AutoSize = True
        CheckBox2.Font = New Font("Segoe UI", 13.8F, FontStyle.Bold)
        CheckBox2.ForeColor = Color.Indigo
        CheckBox2.Location = New Point(21, 114)
        CheckBox2.Margin = New Padding(3, 2, 3, 2)
        CheckBox2.Name = "CheckBox2"
        CheckBox2.Size = New Size(256, 29)
        CheckBox2.TabIndex = 70
        CheckBox2.Text = "Debug errors in program"
        CheckBox2.UseVisualStyleBackColor = True
        ' 
        ' CheckBox1
        ' 
        CheckBox1.AutoSize = True
        CheckBox1.Font = New Font("Segoe UI", 13.8F, FontStyle.Bold)
        CheckBox1.ForeColor = Color.Indigo
        CheckBox1.Location = New Point(21, 71)
        CheckBox1.Margin = New Padding(3, 2, 3, 2)
        CheckBox1.Name = "CheckBox1"
        CheckBox1.Size = New Size(224, 29)
        CheckBox1.TabIndex = 69
        CheckBox1.Text = "Finish documentation"
        ...
        Panel2.Location = New Point(490, 168)
        Panel2.Margin = New Padding(3, 2, 3, 2)
        Panel2.Name = "Panel2"
        Panel2.Size = New Size(342, 266)
        Panel2.TabIndex = 67
        ' 
        ' PictureBox3
        ' 
        PictureBox3.Image = My.Resources.Resources.hours_line_graph
        PictureBox3.Location = New Point(38, 64)
        PictureBox3.Margin = New Padding(3, 2, 3, 2)
        PictureBox3.Name = "PictureBox3"
        PictureBox3.Size = New Size(270, 184)
        ...
        Panel3.Location = New Point(99, 168)
        Panel3.Margin = New Padding(3, 2, 3, 2)
        Panel3.Name = "Panel3"
        Panel3.Size = New Size(347, 266)
        Panel3.TabIndex = 68
        ' 
        ' Label7
        ' 
        ...
        Label7.Location = New Point(45, 208)
        Label7.Name = "Label7"
        Label7.Size = New Size(256, 25)
        Label7.TabIndex = 3
        ...
        Label6.Location = New Point(97, 178)
        Label6.Name = "Label6"
        ...
        Label5.Location = New Point(42, 39)
        Label5.Name = "Label5"
        ...
        Button2.Font = New Font("Segoe UI", 19.8000011F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Button2.ForeColor = Color.White
        Button2.Location = New Point(96, 94)
        ...
        Panel4.Location = New Point(95, 466)
        Panel4.Margin = New Padding(3, 2, 3, 2)
        Panel4.Name = "Panel4"
        Panel4.Size = New Size(351, 266)
        Panel4.TabIndex = 69
        ' 
        ' studentDashboard
        ' 
